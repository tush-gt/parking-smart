    ...
    <div className="landing-screen">
      <nav className="landing-nav">
        <div className="landing-logo">
          <Car size={28} color="#00d2ff" /> Smart Parking
        </div>
      </nav>
      ...
      <main className="landing-hero">
        ...
        <div style={{ display: 'flex', gap: '48px', marginTop: '80px' }}>
          <div style={{ textAlign: 'center' }}>
            <Activity size={32} color="#00d2ff" style={{ margin: '0 auto 16px' }} />
          ...
          <div style={{ textAlign: 'center' }}>
            <Zap size={32} color="#00d2ff" style={{ margin: '0 auto 16px' }} />
          ...
          <div style={{ textAlign: 'center' }}>
            <ShieldCheck size={32} color="#00d2ff" style={{ margin: '0 auto 16px' }} />
